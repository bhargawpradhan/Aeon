...
[![Go Reference](https://pkg.go.dev/badge/github.com/bhargawpradhan/fasthttp)](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp) [![Go Report](https://goreportcard.com/badge/github.com/bhargawpradhan/fasthttp)](https://goreportcard.com/report/github.com/bhargawpradhan/fasthttp)
...
[Documentation](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp)

[Examples from docs](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#pkg-examples)
...
```
go get -u github.com/bhargawpradhan/fasthttp
```
...
There is [net/http -> fasthttp handler converter](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp/fasthttpadaptor),
...
- Fasthttp works with [RequestHandler functions](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestHandler)
...
- The [RequestHandler](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestHandler)
  accepts only one argument - [RequestCtx](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx).
...
- net/http -> fasthttp conversion table:
  ...
  - [r.Body](https://pkg.go.dev/net/http#Request) **➜** [ctx.PostBody()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.PostBody)
  - [r.URL.Path](https://pkg.go.dev/net/url#URL) **➜** [ctx.Path()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.Path)
  - [r.URL](https://pkg.go.dev/net/http#Request) **➜** [ctx.URI()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.URI)
  - [r.Method](https://pkg.go.dev/net/http#Request) **➜** [ctx.Method()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.Method)
  - [r.Header](https://pkg.go.dev/net/http#Request) **➜** [ctx.Request.Header](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestHeader)
  - [r.Header.Get()](https://pkg.go.dev/net/http#Header.Get) **➜** [ctx.Request.Header.Peek()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestHeader.Peek)
  - [r.Host](https://pkg.go.dev/net/http#Request) **➜** [ctx.Host()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.Host)
  - [r.Form](https://pkg.go.dev/net/http#Request) **➜** [ctx.QueryArgs()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.QueryArgs) +
    [ctx.PostArgs()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.PostArgs)
  - [r.PostForm](https://pkg.go.dev/net/http#Request) **➜** [ctx.PostArgs()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.PostArgs)
  - [r.FormValue()](https://pkg.go.dev/net/http#Request.FormValue) **➜** [ctx.FormValue()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.FormValue)
  - [r.FormFile()](https://pkg.go.dev/net/http#Request.FormFile) **➜** [ctx.FormFile()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.FormFile)
  - [r.MultipartForm](https://pkg.go.dev/net/http#Request) **➜** [ctx.MultipartForm()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.MultipartForm)
  - [r.RemoteAddr](https://pkg.go.dev/net/http#Request) **➜** [ctx.RemoteAddr()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.RemoteAddr)
  - [r.RequestURI](https://pkg.go.dev/net/http#Request) **➜** [ctx.RequestURI()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.RequestURI)
  - [r.TLS](https://pkg.go.dev/net/http#Request) **➜** [ctx.IsTLS()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.IsTLS)
  - [r.Cookie()](https://pkg.go.dev/net/http#Request.Cookie) **➜** [ctx.Request.Header.Cookie()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestHeader.Cookie)
  - [r.Referer()](https://pkg.go.dev/net/http#Request.Referer) **➜** [ctx.Referer()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.Referer)
  - [r.UserAgent()](https://pkg.go.dev/net/http#Request.UserAgent) **➜** [ctx.UserAgent()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.UserAgent)
  - [w.Header()](https://pkg.go.dev/net/http#ResponseWriter) **➜** [ctx.Response.Header](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#ResponseHeader)
  - [w.Header().Set()](https://pkg.go.dev/net/http#Header.Set) **➜** [ctx.Response.Header.Set()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#ResponseHeader.Set)
  - [w.Header().Set("Content-Type")](https://pkg.go.dev/net/http#Header.Set) **➜** [ctx.SetContentType()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.SetContentType)
  - [w.Header().Set("Set-Cookie")](https://pkg.go.dev/net/http#Header.Set) **➜** [ctx.Response.Header.SetCookie()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#ResponseHeader.SetCookie)
  - [w.Write()](https://pkg.go.dev/net/http#ResponseWriter) **➜** [ctx.Write()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.Write),
    [ctx.SetBody()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.SetBody),
    [ctx.SetBodyStream()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.SetBodyStream),
    [ctx.SetBodyStreamWriter()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.SetBodyStreamWriter)
  - [w.WriteHeader()](https://pkg.go.dev/net/http#ResponseWriter) **➜** [ctx.SetStatusCode()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.SetStatusCode)
  - [w.(http.Hijacker).Hijack()](https://pkg.go.dev/net/http#Hijacker) **➜** [ctx.Hijack()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.Hijack)
  - [http.Error()](https://pkg.go.dev/net/http#Error) **➜** [ctx.Error()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.Error)
  - [http.FileServer()](https://pkg.go.dev/net/http#FileServer) **➜** [fasthttp.FSHandler()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#FSHandler),
    [fasthttp.FS](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#FS)
  - [http.ServeFile()](https://pkg.go.dev/net/http#ServeFile) **➜** [fasthttp.ServeFile()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#ServeFile)
  - [http.Redirect()](https://pkg.go.dev/net/http#Redirect) **➜** [ctx.Redirect()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.Redirect)
  - [http.NotFound()](https://pkg.go.dev/net/http#NotFound) **➜** [ctx.NotFound()](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.NotFound)
  - [http.StripPrefix()](https://pkg.go.dev/net/http#StripPrefix) **➜** [fasthttp.PathRewriteFunc](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#PathRewriteFunc)

- _VERY IMPORTANT!_ Fasthttp disallows holding references
  to [RequestCtx](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx) or to its'
  members after returning from [RequestHandler](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestHandler).
  ...
  - Wrap RequestHandler into [TimeoutHandler](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#TimeoutHandler).
  - Call [TimeoutError](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.TimeoutError)
    before returning from RequestHandler if there are references to RequestCtx or to its' members.
    See [the example](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#example-RequestCtx-TimeoutError)
    for more details.

Use this brilliant tool - [race detector](http://go.dev/blog/race-detector) -
for detecting and eliminating data races in your program. If you detected
data race related to fasthttp in your program, then there is high probability
you forgot calling [TimeoutError](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.TimeoutError)
before returning from [RequestHandler](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestHandler).

- Blind switching from net/http to fasthttp won't give you performance boost.
  While fasthttp is optimized for speed, its' performance may be easily saturated
  by slow [RequestHandler](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestHandler).
...
- See also [fasthttputil](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp/fasthttputil),
  [fasthttpadaptor](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp/fasthttpadaptor) and
  [expvarhandler](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp/expvarhandler).

## Performance optimization tips for multi-core systems

- Use [reuseport](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp/reuseport) listener.
...
- _Why fasthttp API is incompatible with net/http?_
  ...
  - Compare [net/http connection hijacking](https://pkg.go.dev/net/http#Hijacker)
    to [fasthttp connection hijacking](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.Hijack).
  - Compare [net/http Request.Body reading](https://pkg.go.dev/net/http#Request)
    to [fasthttp request body reading](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.PostBody).
...
- _Why fasthttp doesn't support HTTP/2.0 and WebSockets?_
  ...
  Third parties also may use [RequestCtx.Hijack](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.Hijack)
...
- _Please provide real benchmark data and server information_
  ...
  See [this issue](https://github.com/bhargawpradhan/fasthttp/issues/4).
...
- _I detected data race in fasthttp!_
  ...
  Cool! [File a bug](https://github.com/bhargawpradhan/fasthttp/issues/new). But before
  doing this check the following in your code:

  - Make sure there are no references to [RequestCtx](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx)
    or to its' members after returning from [RequestHandler](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestHandler).
  - Make sure you call [TimeoutError](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx.TimeoutError)
    before returning from [RequestHandler](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestHandler)
    if there are references to [RequestCtx](https://pkg.go.dev/github.com/bhargawpradhan/fasthttp#RequestCtx)
    or to its' members, which may be accessed by other goroutines.

- _I didn't find an answer for my question here_

  Try exploring [these questions](https://github.com/bhargawpradhan/fasthttp/issues?q=label%3Aquestion).
